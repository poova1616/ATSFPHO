...
def load_data(filepath):
    ...
    # Ensure target column is named 'y' for Prophet
    if 'y' not in df.columns:
        raise ValueError("CSV must contain a 'y' column for target values.")
    return df
...
if __name__ == '__main__':
    # Load data
    data_filepath = 'bitcoin_last_3_year.csv'  # Replace with your data file path
